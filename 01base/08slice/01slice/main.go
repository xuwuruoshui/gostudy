...
func main() {
	...
	fmt.Println("slice1 proto:", cap(slice1))
	slice1[2] = 3
	fmt.Println("slice1:", slice1)
	fmt.Println("slice1 proto:", cap(slice1))
	...
	fmt.Println("slice2 proto:", cap(slice2))
	// 扩容机制
	...
	fmt.Println("slice3 proto", cap(slice3))
