...
type StudyClient interface {
	Study(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookRequest, error)
}
...
func (c *studyClient) Study(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookRequest, error) {
	out := new(BookRequest)
	err := c.cc.Invoke(ctx, "/Study/Study", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StudyServer interface {
	Study(context.Context, *BookRequest) (*BookRequest, error)
...
func (UnimplementedStudyServer) Study(context.Context, *BookRequest) (*BookRequest, error) {
